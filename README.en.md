...
<p align="center">
  <strong>A node-based MiniMax H3 visual creation workspace for local and remote ComfyUI</strong>
</p>

<p align="center">
  Video generation · Image generation and editing · Multimodal references · Multi-segment long video · Asset and result management
</p>
...
H3 Studio organizes source media, prompts, model parameters, and generated results on a persistent canvas. The browser handles node composition, reference binding, previews, and project management. A Python service handles secure uploads, workflow compilation, the ComfyUI queue, result downloads, and recovery. Canvases are saved automatically, and you can maintain multiple independent workflows at once.
...
<p align="center">
  <img src="docs/assets/readme/canvas-workflow.png" width="100%" alt="H3 Studio node canvas with an image reference, an H3 video node, and an output node">
</p>
...
This lightweight animation is a five-second excerpt, beginning at the first usable frame, from a 9:16, 15.08-second video with audio generated by H3 Studio. Only the silent animation is public; the complete generated file is not included in the repository.

[![H3 Studio generated video preview: an animated singer performing on stage](docs/assets/readme/generated-video-preview.gif)](docs/assets/readme/generated-video-preview.gif?raw=1)
...
<p align="center">
  <img src="docs/assets/readme/long-video-editor.png" width="100%" alt="H3 Studio Long Video editor with a monitor, storyboard timeline, and existing media segment">
</p>
...
- FFmpeg performs an auditable hard-cut merge. H3 Studio does not claim automatic seamless audio/video transitions.
